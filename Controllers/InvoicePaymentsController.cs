...
namespace BillingSystem.Controllers
{
    public class InvoicePaymentsController : Controller
    {
        ...
        public InvoicePaymentsController(InvoiceSystemContext context)
        {
            _context = context;
        }
        ...
        {
            var invoiceSystemContext = _context.InvoicePayments.Include(i => i.PreviousPaymentNavigation).Include(i => i.StudentNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'InvoiceSystemContext.InvoicePayments'  is null.");
            }
            var invoicePayment = await _context.InvoicePayments
               .Include(i => i.PreviousPaymentNavigation)
               .Include(i => i.StudentNavigation)
